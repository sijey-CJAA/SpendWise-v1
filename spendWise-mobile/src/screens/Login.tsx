    ...
    <SafeAreaView className="flex-1 bg-emerald-50">
      ...
      >
        <View className="items-center mb-12">
          <View className="w-20 h-20 rounded-full bg-white justify-center items-center mb-6 shadow-lg shadow-emerald-500/20 elevation-lg">
            <ExpoImage 
        ...
        <View className="mb-8">
          ...
          <Animated.View style={{ transform: [{ scale: scaleAnim }] }}>
            <TouchableOpacity 
              className="bg-blue-500 h-14 rounded-2xl justify-center items-center shadow-lg shadow-blue-500/30 elevation-md"
        ...
        <View className="flex-row justify-center items-center">
          ...
          <TouchableOpacity onPress={() => setIsLoginMode(!isLoginMode)}>
            <Text className="text-emerald-500 text-base font-bold">{isLoginMode ? 'Sign up' : 'Login'}</Text>
          </TouchableOpacity>
        </View>
      </KeyboardAvoidingView>
    </SafeAreaView>
